      ...
      <div className="row align-items-center g-lg-5">
        <div className="col-lg-7 text-start">
          ...
          <p className="text-lg-start mt-3 fw-bold">
            Experience the best cinema quality at CGV cinemas nationwide. <br />
            Find showtimes and trailers for the latest movies at CGV Cinemas Vietnam.
          </p>
        </div>
        <div className="col-md-10 mx-auto col-lg-5">
          ...
          >
            ...
            <p>Enter the email address linked to your CGV Cinemas account.</p>
