...
function Showtime() {
  ...
  if (cineplexs.data.length > 0) {
    cineplexs.data.forEach((cineplex) => {
      options.push({ value: cineplex.id, label: cineplex.name });
    });
  }
  ...
  return (
    <main className="flex-shrink-0">
      <Container className="w-75">
        <Row>
          <h3 className="text-center">SHOWTIMES</h3>
        </Row>

        {/* Cineplex Selector */}
        <Row style={{ paddingLeft: 150, paddingRight: 142 }}>
          <Form.Group className="ms-1">
            <Form.Label className="form-group required control-label">Select Cineplex</Form.Label>
            <Select
